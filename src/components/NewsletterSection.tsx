      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            Fique por dentro de tudo que acontece em nossa empresa e comunidade.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {NEWS.map((news, index) => (
            <Link 
              ...
              className="group bg-white/80 backdrop-blur-sm rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 hover:-translate-y-3 transform-gpu"
            >
              {/* Image */}
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute bottom-4 right-4">
                  <div className="flex items-center gap-2 px-3 py-1 bg-black/50 backdrop-blur-sm text-white text-xs rounded-full">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-[#282e76]/10 via-white/50 to-[#0d7c3d]/10 rounded-3xl border border-[#0d7c3d]/20 p-8 lg:p-12 backdrop-blur-sm">
            ...
            <Link
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#282e76] hover:bg-[#0d7c3d] text-white rounded-xl font-semibold transition-all duration-300 transform hover:-translate-y-1"
            >
